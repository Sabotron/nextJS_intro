  ...
  return (
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <h1 className='text-blue-500'>Black triangle made with Tailwind</h1>
        <div className='relative w-0 h-0 border-l-[15px] border-r-[15px] border-b-[26px] border-l-transparent border-r-transparent border-b-black'  ></div>
          <h1 className='text-blue-500'>Black triangle made with CSS Modules</h1>
